 ...
 *	  source text
 *
 * Portions Copyright (c) 2011-2012, NIPPON TELEGRAPH AND TELEPHONE CORPORATION
...
/*
 * deparse_expression_pg			- General utility for deparsing expressions
 *
 * calls deparse_expression_pretty with all prettyPrinting disabled
 */
char *
deparse_expression_pg(Node *expr, List *dpcontext,
				   bool forceprefix, bool showimplicit)
{
